...
public class ContractSelectAttorneyDocumentDate extends TestBase{
	    @Test
	    	public void ContractSelectAttorneyDocumentDate_C14988() {  		
	    		waitContractPageToLoad();//загружаем страницу заключения контракта
	    		
	    		driver.findElement(By.xpath("//div[4]/div/div/div/input")).click();// нажимаем на выбор даты, от которой выдана доверенность 
