...
public class ContractNoFieldsFLTest extends TestBase{
	    @Test
	    	public void contractNoFieldsFLTest_C32044() {  		
	    		...
	    		sleep();
	    		assertEquals(driver.findElement(By.cssSelector("div.bContent__innerHeader")).getText(), "Договор");
	    	}
