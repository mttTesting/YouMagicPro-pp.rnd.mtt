...
public class GroupsAddEmployeeIconClickTest extends TestBase {
	...
	driver.findElement(By.xpath("//td[5]/a/span")).click();//нажимаем на иконку добавления пользователей
	wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[3]/div/div/div/span")));//ждем загрузки страницы, проверяем, что открылось окно Список пользователей
