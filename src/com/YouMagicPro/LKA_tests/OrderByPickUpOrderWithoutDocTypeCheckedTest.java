...
public class OrderByPickUpOrderWithoutDocTypeCheckedTest  extends TestBase{
	...
	public void orderByPickUpOrderWithoutDocTypeCheckedTest_C25663() {
		...
		driver.findElement(By.xpath("//input[@id='edit-submit']")).click();//нажатие на "сохранить"
		sleep();
		assertEquals(driver.findElement(By.cssSelector("div.errors_for_messages.error")).getText(), "Необходимо выбрать тип документа");
