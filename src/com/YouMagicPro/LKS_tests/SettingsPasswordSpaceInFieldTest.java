...
public class SettingsPasswordSpaceInFieldTest extends TestBase{
	...
	public void settingsPasswordSpaceInFieldTest_C15289 () throws Exception {	 
		...
		driver.findElement(By.id("edit-pass1")).sendKeys("   ");//ввод пробелов в поле ввода пароля
		driver.findElement(By.id("edit-pass2")).sendKeys("   ");//подтверждение пароля
		...
		sleep();
		driver.findElement(By.id("edit-user-password")).sendKeys("   ");//ввод пробелов в поле ввода старого пароля
